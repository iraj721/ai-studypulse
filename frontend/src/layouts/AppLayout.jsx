...
export default function FloatingTimer() {
  ...
  // ✅ Complete close - hide the floating timer
  const handleClose = () => {
    setIsVisible(false);
    // Optionally pause the timer when closed
    pauseTimer();
  };

  // ✅ Show again when coming from timer page
  const handleShow = () => {
    setIsVisible(true);
  };
    ...
    >
      ...
      <div className="floating-timer-header" onMouseDown={handleMouseDown}>
        ...
        <div className="timer-header-actions">
          ...
          {/* ✅ Cross button - completely closes the timer */}
